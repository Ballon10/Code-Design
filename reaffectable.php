...
// Filtre pour verifier si l'element existe deja
  ...
  <script defer src="../dataTable/js/jquery.js"></script>
  <script defer src="../dataTable/js/bootstrap.bundle.min.js"></script>
  <script defer src="../dataTable/js/dataTables.js"></script>
  <script defer src="../dataTable/js/dataTables.bootstrap5.js"></script>
  <script defer src="../dataTable/script.js"></script>
          ...
          <li class="nav-item">
            ...
            <i class="nav-icon fas fa-warehouse"></i>
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="reaffectable.php" class="nav-link active"><i class="far fa-circle nav-icon"></i>
                  <p>
                  <?php 
                      $count = $con -> query("SELECT count(*) FROM attribution WHERE interventionType='Recycle' OR interventionType='Rejeter'");
				  ...
				  <div class="col-md-6">
					  <form id="filterForm" action="" method="get" class="form-inline">
						  ...
						  <select name="status" class="form-control" required>
							  <option value="">Select Type Materiel</option>
							  <option value="Laptop"<?= isset($_GET['type']) == true ? $_GET['type'] == 'Laptop': '' ?>>Laptop</option>
							  <option value="Desktop"<?= isset($_GET['type']) == true ? $_GET['type'] == 'Desktop': '' ?>>Desktop</option>
						  </select>
			  ...
			  ?>
					<tbody>
						...
						<tr>
							...
							<td align="center">
								...
								<div class="dropdown-menu" role="menu">
								  <a class="dropdown-item" href="reaffecter.php?item=<?php echo $row['id'] ?>" data-id=""><span class="fa fa-edit text-primary"></span>Reaffecter</a>
								  <div class="dropdown-divider"></div>
								  <a class="dropdown-item" href="rebuts.php?item=<?php echo $row['id'] ?>"><span class="fa fa-trash text-danger"></span>Mettre au rebut</a>
								  <div class="dropdown-divider"></div>
								</div>
							</td>
						</tr>
						<?php
						  ...
						  $i=0;
						  $array = $con->query("SELECT * FROM attribution WHERE interventionType='Recycle' OR interventionType='Rejeter' ORDER BY id DESC");
